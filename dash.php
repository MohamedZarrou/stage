...
try {
    ...
    error_log("Error fetching user image: " . $e->getMessage());
}
        ...
        <ul class="navbar-nav ms-3">
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              <li><a class="dropdown-item" href="Profile/Myprofile.php"><i class="bi bi-person me-2"></i> My Profile</a></li>
              <li><a class="dropdown-item" href="Profile/Mydiploms.php"><i class="bi bi-file-earmark-text me-2"></i> My Diplomas</a></li>
              <li><a class="dropdown-item" href="Profile/MyHistory.php"><i class="bi bi-building me-2"></i> My History</a></li>
            ...
            <a href="gestion.php?PPR=<?= urlencode($user['PPR']) ?>" class="text-decoration-none">
              <div class="card user-card">
                <div class="user-image-container">
                  <img src="image.php?PPR=<?= urlencode($user['PPR']) ?>" class="user-image" alt="Image of <?= htmlspecialchars($user['nom']) ?>">
